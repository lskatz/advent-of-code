...
my @sortedCoordinates = sort{$$a[2] <=> $$b[2]} @$distFromOrigin;

# answer: 217 (coordinate 100217, 100000)
is($sortedCoordinates[0][2], 217, "Expected 217");
